...
var ApiManager = function(server, opts) {
  ...
  if (opts && opts.test) {
    console.log("Test Mode (Using a smiluated board)")
...
/**
 * socketBroadcast informs new state in the resource 
 * @return {ApiManager}
 */ 
ApiManager.prototype.socketBroadcast = function(resource, id, data) {
